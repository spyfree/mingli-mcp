        ...
        return format_success_response(
            {
                ...
                # 提供可选的配置Schema以便客户端展示和理解（所有配置均为可选）
                "configSchema": {
                    "type": "object",
                    "description": "服务器可选配置（通过环境变量或 .env 提供）。不配置也可直接运行。",
                    "additionalProperties": False,
                    "properties": {
                        "LOG_LEVEL": {
                            "type": "string",
                            "description": "日志级别：DEBUG/INFO/WARNING/ERROR/CRITICAL。默认 INFO",
                            "default": "INFO",
                            "examples": ["DEBUG", "INFO"],
                        },
                        "TRANSPORT_TYPE": {
                            "type": "string",
                            "description": "传输协议类型：stdio 或 http。默认 stdio",
                            "default": "stdio",
                            "enum": ["stdio", "http"],
                            "examples": ["stdio", "http"],
                        },
                        "HTTP_HOST": {
                            "type": "string",
                            "description": "HTTP监听地址（仅http模式）",
                            "default": "0.0.0.0",
                            "examples": ["127.0.0.1", "0.0.0.0"],
                        },
                        "HTTP_PORT": {
                            "type": "integer",
                            "description": "HTTP监听端口（仅http模式）",
                            "default": 8080,
                            "examples": [8080, 3000],
                        },
                        "HTTP_API_KEY": {
                            "type": "string",
                            "description": "HTTP API密钥（仅http模式，可选；为空则不启用认证）",
                            "default": "",
                        ...
                        "WS_HOST": {
                            "type": "string",
                            "description": "WebSocket监听地址（预留）",
                            "default": "0.0.0.0",
                            "examples": ["127.0.0.1"],
                        },
                        "WS_PORT": {
                            "type": "integer",
                            "description": "WebSocket监听端口（预留）",
                            "default": 8081,
                            "examples": [8081],
                        },
                    },
