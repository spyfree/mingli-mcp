...
- QUICK_START_PYPI.md - PyPI installation

### 🏗️ Architecture & Implementation
- ARCHITECTURE.md - System architecture
- BAZI_IMPLEMENTATION.md - BaZi implementation details
- PROJECT_SUMMARY.md - Project summary

### 🚀 Deployment
- DEPLOYMENT.md - General deployment
- DEPLOYMENT_SUMMARY.md - Deployment comparison
- CLOUDFLARE_DEPLOY.md - Cloudflare setup
- CLOUDFLARE_EXPLAINED.md - Cloudflare explanation
- PYPI_PUBLISH.md - Publishing guide

### 🔌 Client Integration
- MCP_CLIENT_CONFIG.md - Universal MCP config
- COZE_GUIDE.md - Coze integration
- COZE_CONFIG_GUIDE.md - Coze configuration
